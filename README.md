...
微信输入法加不了热词,豆包把打字和语音焊在一起,智谱够全但慢。Voice Brother 用本地模型把这些问题一次解决:按住快捷键(键盘修饰键,**或鼠标侧键**)说话,松开就把文字送到光标处。识别在你自己的 Mac 上跑,够快,还能喂进你专业领域的热词和替换规则。它顺带还是个系统级录音器，可以无感录制视频会议，微信电话等对话音频，同时时间声音的文本转换。拓展功能也包含屏幕录制。
...
**5. 系统级声音录制**。充分发挥本地语音模型的优势，可自动将系统级音频自动录制后，转化成文字。因此，腾讯会议、微信电话等都可以，无感的快速记录。
